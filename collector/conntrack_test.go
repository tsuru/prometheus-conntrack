...
func TestConvertContrackEntryToConn(t *testing.T) {
	...
	ctConn := []ct.Con{
		{
			Origin:    &ct.IPTuple{Src: parseIP("192.0.2.1"), Proto: &ct.ProtoTuple{}},
			Reply:     &ct.IPTuple{Src: parseIP("192.0.2.2"), Proto: &ct.ProtoTuple{}},
			ProtoInfo: nil,
		},
		{
			Origin:    &ct.IPTuple{Src: parseIP("192.0.2.1"), Proto: &ct.ProtoTuple{}},
		...
		{
			Origin:    &ct.IPTuple{Src: parseIP("192.0.2.1"), Proto: &ct.ProtoTuple{SrcPort: portPtr(8080)}},
			Reply:     &ct.IPTuple{Src: parseIP("192.0.2.2"), Proto: &ct.ProtoTuple{SrcPort: portPtr(8081)}},
			ProtoInfo: &ct.ProtoInfo{TCP: &ct.TCPInfo{State: &TCP_CONNTRACK_ESTABLISHED}},
		},
		{
			Origin:    &ct.IPTuple{Src: parseIP("192.0.2.1"), Proto: &ct.ProtoTuple{SrcPort: portPtr(8080)}},
			Reply:     &ct.IPTuple{Src: parseIP("192.0.2.4"), Proto: &ct.ProtoTuple{SrcPort: portPtr(8081)}},
			ProtoInfo: &ct.ProtoInfo{TCP: &ct.TCPInfo{State: &TCP_CONNTRACK_SYN_SENT}},
			Timestamp: &ct.Timestamp{Start: &now},
		},
		{
			Origin:    &ct.IPTuple{Src: parseIP("192.0.2.1"), Proto: &ct.ProtoTuple{SrcPort: portPtr(8080)}},
			Reply:     &ct.IPTuple{Src: parseIP("192.0.2.3"), Proto: &ct.ProtoTuple{SrcPort: portPtr(8081)}},
			ProtoInfo: &ct.ProtoInfo{TCP: &ct.TCPInfo{State: &TCP_CONNTRACK_SYN_SENT}},
